...
const Header = ({ title, subtitle, emphasis, color = "#b80000" }) => {
  return (
    <div className="one relative">
      <h1 className="relative text-center uppercase font-[Raleway] font-light text-[40px] text-[#080808] transition-all duration-400 ease-in-out pb-[30px]">
        {title}{" "}
        ...
        <motion.span
          className="absolute -bottom-[2px] left-[47.5%] -translate-x-1/2 z-10"
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
